...
const DeleteModal = props => {
  ...
  return (
    <div ref={modalRef} className={classes.DeleteModal}>
      ...
      {props.userIsAdmin ? <>
      <div>Are you sure you want to delete this {props.mode}? This action cannot be undone. Type "{props.confirmText}" below to confirm.</div>
      ...
      : <div>You must be an admin to delete this {props.mode}.</div>}
    </div>
  );
};
