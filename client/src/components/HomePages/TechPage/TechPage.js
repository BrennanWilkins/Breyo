...
import * as Imgs from './TechAssets/imgs';
...
const TechPage = () => (
  <div>
    ...
    <div className={classes.Section}>
      <div className={classes.Img}>{Imgs.ReactImg}</div>
    ...
    <div className={classes.Section}>
      <div className={classes.Img}>{Imgs.ReduxImg}</div>
      <div className={classes.Info}>
        <h2>Redux</h2>
    ...
    <div className={classes.Section}>
      <div className={classes.Img}>{Imgs.NodeJSImg}</div>
      <div className={classes.Info}>
        <h2>Node.js</h2>
    ...
    <div className={classes.Section}>
      <div className={classes.Img}>{Imgs.SocketIOImg}</div>
      <div className={classes.Info}>
        <h2>Socket.IO</h2>
    ...
    <div className={classes.Section}>
      <div className={classes.Img}>{Imgs.MongoDBImg}</div>
      <div className={classes.Info}>
        <h2>MongoDB</h2>
