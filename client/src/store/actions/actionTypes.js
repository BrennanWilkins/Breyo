...
export const SET_SHOWN_BOARD_VIEW = 'SET_SHOWN_BOARD_VIEW';
export const TOGGLE_CREATE_BOARD = 'TOGGLE_CREATE_BOARD';
export const SET_CREATE_BOARD_TEAM = 'SET_CREATE_BOARD_TEAM';
export const JOIN_BOARD = 'JOIN_BOARD';
export const CHANGE_BOARD_TEAM = 'CHANGE_BOARD_TEAM';
export const REMOVE_BOARD_FROM_TEAM = 'REMOVE_BOARD_FROM_TEAM';
export const CREATE_NEW_CUSTOM_LABEL = 'CREATE_NEW_CUSTOM_LABEL';
export const UPDATE_CUSTOM_LABEL = 'UPDATE_CUSTOM_LABEL';
export const DELETE_CUSTOM_LABEL = 'DELETE_CUSTOM_LABEL';
export const CREATE_CUSTOM_FIELD = 'CREATE_CUSTOM_FIELD';
export const UPDATE_CUSTOM_FIELD_TITLE = 'UPDATE_CUSTOM_FIELD_TITLE';
...
export const SET_VOTING_RESULTS_ID = 'SET_VOTING_RESULTS_ID';
export const CLOSE_VOTING_RESULTS = 'CLOSE_VOTING_RESULTS';
...
export const ADD_CUSTOM_LABEL_SEARCH_QUERY = 'ADD_CUSTOM_LABEL_SEARCH_QUERY';
...
export const DELETE_CUSTOM_FIELD_FROM_CARD = 'DELETE_CUSTOM_FIELD_FROM_CARD';
export const TOGGLE_CARD_VOTE = 'TOGGLE_CARD_VOTE';
export const ADD_CARD_CUSTOM_LABEL = 'ADD_CARD_CUSTOM_LABEL';
export const DELETE_CARD_CUSTOM_LABEL = 'DELETE_CARD_CUSTOM_LABEL';
export const CHANGE_CHECKLIST_ITEM_MEMBER = 'CHANGE_CHECKLIST_ITEM_MEMBER';
export const REMOVE_CHECKLIST_ITEM_MEMBER = 'REMOVE_CHECKLIST_ITEM_MEMBER';
export const CHANGE_CHECKLIST_ITEM_DUE_DATE = 'CHANGE_CHECKLIST_ITEM_DUE_DATE';
export const REMOVE_CHECKLIST_ITEM_DUE_DATE = 'REMOVE_CHECKLIST_ITEM_DUE_DATE';
...
export const REJECT_TEAM_INVITE = 'REJECT_TEAM_INVITE';
export const PROMOTE_TEAM_MEMBER = 'PROMOTE_TEAM_MEMBER';
export const DEMOTE_TEAM_MEMBER = 'DEMOTE_TEAM_MEMBER';
export const DEMOTE_SELF_TEAM_MEMBER = 'DEMOTE_SELF_TEAM_MEMBER';
export const PROMOTE_SELF_TEAM_MEMBER = 'PROMOTE_SELF_TEAM_MEMBER';
export const ADD_TEAM_MEMBER = 'ADD_TEAM_MEMBER';
export const DELETE_TEAM_MEMBER = 'DELETE_TEAM_MEMBER';

// roadmap actionTypes
export const SET_ROADMAP_DATE_RANGE = 'SET_ROADMAP_DATE_RANGE';
export const SET_ROADMAP_MODE = 'SET_ROADMAP_MODE';
export const RESET_ROADMAP_SETTINGS = 'RESET_ROADMAP_SETTINGS';
